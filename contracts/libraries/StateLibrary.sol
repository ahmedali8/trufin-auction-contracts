...
//     /// @param params The auction parameters, including token address, total tokens, start time,
// and
//     /// end time.
...
//     /// @notice Allows a winning bidder to claim tokens or a non-winning bidder to claim a
// refund.
